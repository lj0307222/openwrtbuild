...
svn co https://github.com/vernesong/OpenClash/trunk/luci-app-openclash ./packeage/openclash
...
export Customized_Information="$(TZ=UTC-8 date "+%Y.%m")"  # 个性签名,你想写啥就写啥，(填0为不作修改)
